...
export default function () {
	...
	if (selectedLayers.length === 0) {
		...
		var labelParagraph = createTextDataLabel("Paragraph", NSMakeRect(160,85,120,15)); 
		...
		[box, labelTotalChar, valueTotalChar, labelWords, valueWords, labelParagraph, valueParagraph, copyLabel, copyButton].forEach(i => panelContent.addSubview(i));
